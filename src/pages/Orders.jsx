...
const Orders = () => {
  const { orders, loading, dashboardOrders } = useOrders();
  ...
  return (
    <div className="space-y-3 sm:space-y-4">
      ...
      {/* Stats */}
      <OrdersStats orders={dashboardOrders|| []} />
        ...
        {loading ? (
          ...
          paginatedOrders.map((order) => (
            ...
            >
              ...
              <td className="px-3 sm:px-4 py-2 sm:py-2.5 text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">
                {order.customerPhone || "-"}
              </td>
              <td className="px-3 sm:px-4 py-2 sm:py-2.5 text-sm text-gray-700 dark:text-gray-300">
                {order.serviceSummary}
              </td>
              <td className="px-3 sm:px-4 py-2 sm:py-2.5 text-sm font-semibold text-gray-900 dark:text-white whitespace-nowrap">
                ₹{order.totalAmount}
              </td>
              ...
              <td className="px-3 sm:px-4 py-2 sm:py-2.5 text-center">
                <Eye
                  ...
                  className="inline-block cursor-pointer text-gray-500 dark:text-gray-400 hover:text-[#E8A843] dark:hover:text-[#E8A843] transition-colors"
                />
              </td>
            </tr>
          ))
          ...
          <tr>
            <td colSpan={7} className="py-10 sm:py-16 text-center">
              <div className="flex flex-col items-center gap-2.5 sm:gap-3 px-4">
