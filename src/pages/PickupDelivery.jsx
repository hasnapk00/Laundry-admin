...
const PickupDelivery = () => {
  ...
  return (
    <div className="space-y-3  md:space-y-4 ">
        ...
        <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 px-3 py-1.5 pl-8 outline-none transition-colors focus:border-[#E8A843] lg:w-72 text-sm"
            />
          </div>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:gap-2.5">
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white px-3 py-1.5 pr-9 outline-none transition-colors focus:border-[#E8A843] text-sm"
              >
            ...
            <input
              ...
              className="rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white px-3 py-1.5 outline-none transition-colors focus:border-[#E8A843] text-sm"
            />
      ...
      <div className="rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1a1a1a] p-1 shadow-sm transition-colors duration-200">
...
const SummaryCard = ({ title, value, icon: Icon }) => (
  <div className="rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1a1a1a] p-2.5 sm:p-3 shadow-sm hover:shadow-md dark:hover:shadow-gray-900/50 transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-700">
    <div className="flex items-center justify-between gap-2">
      <div className="min-w-0">
        <p className="text-[10px] sm:text-xs font-semibold text-gray-500 dark:text-gray-400 tracking-wide uppercase truncate">{title}</p>

        <h2 className="mt-0.5 text-lg sm:text-xl font-bold text-gray-900 dark:text-white tracking-tight">
          {value}
        </h2>
      </div>

      <div className="shrink-0 rounded-lg bg-[#F4EFD9] dark:bg-[#E8A843]/10 p-2">
        <Icon className="text-[#E8A843]" size={16} />
      </div>
    </div>
  </div>
);
